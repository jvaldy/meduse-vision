 ...
 */
final class Version20250130140858 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cycle (id INT AUTO_INCREMENT NOT NULL, start_date DATE NOT NULL, cycle_length INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
