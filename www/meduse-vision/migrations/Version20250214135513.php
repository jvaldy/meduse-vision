 ...
 */
final class Version20250214135513 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE episode_maker CHANGE created_at created_at VARCHAR(19) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE episode_maker CHANGE created_at created_at VARCHAR(19) DEFAULT NULL');
